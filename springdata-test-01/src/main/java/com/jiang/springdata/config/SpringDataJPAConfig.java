package com.jiang.springdata.config;
...
@EnableJpaRepositories(basePackages="com.jiang.springdata.repositories")  // 启动jpa    <jpa:repositories
...
public class SpringDataJPAConfig {
    ...
    * */
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.jiang.springdata.pojo");
