...
//        CustomerRepository repositories = ioc.getBean(CustomerRepository.class);
//
//        System.out.println(repositories.getClass());   //jdk动态
//        Optional<Customer> byId = repositories.findById(20L);
//
